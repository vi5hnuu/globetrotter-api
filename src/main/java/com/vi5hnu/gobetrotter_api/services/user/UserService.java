...
public class UserService{
    ...
    public com.vi5hnu.gobetrotter_api.commons.Pageable<UserDto> findAllUsers(int pageNo, int count) throws ApiException {//pageNo from 1 onwards
        ...
        return new com.vi5hnu.gobetrotter_api.commons.Pageable<>(users.stream().map(UserModel::toDto).toList(),pageNo,totalUsers);
    }
